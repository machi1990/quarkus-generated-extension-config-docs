...
`quarkus.rt.rt-string-opt` icon:gears[title=Overridable at runtime]::
+
--
A run time object
...
`quarkus.rt.rt-string-opt-with-default` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.rt.all-values.long-primitive` icon:gears[title=Overridable at runtime]::
+
--
a long primitive
...
`quarkus.rt.all-values.double-primitive` icon:gears[title=Overridable at runtime]::
+
--
a double primitive
...
`quarkus.rt.all-values.long-value` icon:gears[title=Overridable at runtime]::
+
--
a long value
...
`quarkus.rt.all-values.opt-long-value` icon:gears[title=Overridable at runtime]::
+
--
an optional long value
...
`quarkus.rt.all-values.opt-double-value` icon:gears[title=Overridable at runtime]::
+
--
an optional double value
...
`quarkus.rt.all-values.optional-long-value` icon:gears[title=Overridable at runtime]::
+
--
an optional long value
...
`quarkus.rt.all-values.oov` icon:gears[title=Overridable at runtime]::
+
--
A config object with a static of(String) method
...
`quarkus.rt.all-values.oov-with-default` icon:gears[title=Overridable at runtime]::
+
--
A config object with a static of(String) method and default value
...
`quarkus.rt.all-values.ovo` icon:gears[title=Overridable at runtime]::
+
--
A config object with a static valueOf(String) method
...
`quarkus.rt.all-values.ovo-with-default` icon:gears[title=Overridable at runtime]::
+
--
A config object with a static of(String) method and default value
...
`quarkus.rt.all-values.string-list` icon:gears[title=Overridable at runtime]::
+
--
A List of string values
...
`quarkus.rt.all-values.long-list` icon:gears[title=Overridable at runtime]::
+
--
A List of long values
...
`quarkus.rt.all-values.expanded-default` icon:gears[title=Overridable at runtime]::
+
--
A configuration item that has a default value that is an expression
...
[[quarkus.rt.my-enum]]
`quarkus.rt.my-enum` icon:gears[title=Overridable at runtime]::
+
--
Enum object
...
[[quarkus.rt.my-enums]]
`quarkus.rt.my-enums` icon:gears[title=Overridable at runtime]::
+
--
Enum list of objects
...
`quarkus.rt.my-optional-enums` icon:gears[title=Overridable at runtime]::
+
--
Enum optional value
...
`quarkus.rt.no-hyphenate-first-enum` icon:gears[title=Overridable at runtime]::
+
--
No hyphenation
...
`quarkus.rt.no-hyphenate-second-enum` icon:gears[title=Overridable at runtime]::
+
--
No hyphenation
...
`quarkus.rt.primitive-boolean` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.rt.object-boolean` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.rt.primitive-integer` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.rt.object-integer` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.rt.one-to-nine` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.rt.string-map."<string-map>"` icon:gears[title=Overridable at runtime]::
+
--
A map of properties
...
`quarkus.rt.string-list-map."<string-list-map>"` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.rt.all-values.nested-config-map."<nested-config-map>".nested-value` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.rt.all-values.nested-config-map."<nested-config-map>".oov` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.rt.all-values.string-map."<string-map>"` icon:gears[title=Overridable at runtime]::
+
--
A map of properties
...
`quarkus.rt.all-values.string-list-map."<string-list-map>"` icon:gears[title=Overridable at runtime]::
+
--
A map of property lists
...
`quarkus.rt.map-of-numbers."<map-of-numbers>"` icon:gears[title=Overridable at runtime]::
+
--
