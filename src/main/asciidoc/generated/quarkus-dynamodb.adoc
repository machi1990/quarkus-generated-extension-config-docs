...
`quarkus.dynamodb.region` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.enable-endpoint-discovery` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.endpoint-override` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.credentials.type` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.credentials.default-provider.async-credential-update-enabled` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.credentials.default-provider.reuse-last-provider-enabled` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.credentials.static-provider.access-key-id` icon:gears[title=Overridable at runtime]::
+
--
Access key id
...
`quarkus.dynamodb.credentials.static-provider.secret-access-key` icon:gears[title=Overridable at runtime]::
+
--
Secret access key
...
`quarkus.dynamodb.credentials.profile-provider.profile-name` icon:gears[title=Overridable at runtime]::
+
--
Profile name 
...
`quarkus.dynamodb.credentials.process-provider.async-credential-update-enabled` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.credentials.process-provider.credential-refresh-threshold` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.credentials.process-provider.process-output-limit` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.credentials.process-provider.command` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.sync-client.connection-acquisition-timeout` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.sync-client.connection-max-idle-time` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.sync-client.connection-timeout` icon:gears[title=Overridable at runtime]::
+
--
Connection timeout
...
`quarkus.dynamodb.sync-client.connection-time-to-live` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.sync-client.socket-timeout` icon:gears[title=Overridable at runtime]::
+
--
Socket timeout
...
`quarkus.dynamodb.sync-client.max-connections` icon:gears[title=Overridable at runtime]::
+
--
Max connections
...
`quarkus.dynamodb.sync-client.expect-continue-enabled` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.sync-client.use-idle-connection-reaper` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.sync-client.proxy.enabled` icon:gears[title=Overridable at runtime]::
+
--
Enable HTTP proxy
...
`quarkus.dynamodb.sync-client.proxy.endpoint` icon:gears[title=Overridable at runtime]::
+
--
Proxy endpoint
...
`quarkus.dynamodb.sync-client.proxy.username` icon:gears[title=Overridable at runtime]::
+
--
Proxy username
...
`quarkus.dynamodb.sync-client.proxy.password` icon:gears[title=Overridable at runtime]::
+
--
Proxy password
...
`quarkus.dynamodb.sync-client.proxy.ntlm-domain` icon:gears[title=Overridable at runtime]::
+
--
NTLM domain
...
`quarkus.dynamodb.sync-client.proxy.ntlm-workstation` icon:gears[title=Overridable at runtime]::
+
--
NTLM workstation
...
`quarkus.dynamodb.sync-client.proxy.preemptive-basic-authentication-enabled` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.sync-client.proxy.non-proxy-hosts` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.async-client.max-concurrency` icon:gears[title=Overridable at runtime]::
+
--
Max concurrency
...
`quarkus.dynamodb.async-client.max-pending-connection-acquires` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.async-client.read-timeout` icon:gears[title=Overridable at runtime]::
+
--
Read timeout
...
`quarkus.dynamodb.async-client.write-timeout` icon:gears[title=Overridable at runtime]::
+
--
Write timeout
...
`quarkus.dynamodb.async-client.connection-timeout` icon:gears[title=Overridable at runtime]::
+
--
Connection timeout
...
`quarkus.dynamodb.async-client.connection-acquisition-timeout` icon:gears[title=Overridable at runtime]::
+
--
Connection acquisition timeout
...
`quarkus.dynamodb.async-client.connection-time-to-live` icon:gears[title=Overridable at runtime]::
+
--
Connection time to live
...
`quarkus.dynamodb.async-client.connection-max-idle-time` icon:gears[title=Overridable at runtime]::
+
--
Connection max idle time
...
`quarkus.dynamodb.async-client.use-idle-connection-reaper` icon:gears[title=Overridable at runtime]::
+
--
Use idle connection reaper
...
`quarkus.dynamodb.async-client.protocol` icon:gears[title=Overridable at runtime]::
+
--
HTTP protocol
...
`quarkus.dynamodb.async-client.max-http2-streams` icon:gears[title=Overridable at runtime]::
+
--
Max Http2 streams
...
`quarkus.dynamodb.async-client.ssl-provider` icon:gears[title=Overridable at runtime]::
+
--
SSL provider
...
`quarkus.dynamodb.async-client.event-loop.override` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.async-client.event-loop.number-of-threads` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.dynamodb.async-client.event-loop.thread-name-prefix` icon:gears[title=Overridable at runtime]::
+
--
