...
4+h|Query related configuration link:#quarkus.hibernate-orm.query[icon:plus-circle[], title=More information about Query related configuration]
...
4+h|Database related configuration link:#quarkus.hibernate-orm.database[icon:plus-circle[], title=More information about Database related configuration]
...
4+h|JDBC related configuration link:#quarkus.hibernate-orm.jdbc[icon:plus-circle[], title=More information about JDBC related configuration]
...
4+h|Logging configuration link:#quarkus.hibernate-orm.log[icon:plus-circle[], title=More information about Logging configuration]
...
4+h|Caching configuration link:#quarkus.hibernate-orm.cache[icon:plus-circle[], title=More information about Caching configuration]
...
***
[[quarkus.hibernate-orm.database]]
