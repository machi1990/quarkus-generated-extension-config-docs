...
`quarkus.datasource.initial-size` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.datasource.min-size` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.datasource.background-validation-interval` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.datasource.acquisition-timeout` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.datasource.leak-detection-interval` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.datasource.idle-removal-interval` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.datasource.max-lifetime` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.datasource.transaction-isolation-level` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.datasource.enable-metrics` icon:gears[title=Overridable at runtime]::
+
--
...
`quarkus.datasource."<named-data-sources>".url` icon:gears[title=Overridable at runtime]::
+
--
The datasource URL
...
`quarkus.datasource."<named-data-sources>".username` icon:gears[title=Overridable at runtime]::
+
--
The datasource username
...
`quarkus.datasource."<named-data-sources>".password` icon:gears[title=Overridable at runtime]::
+
--
The datasource password
...
`quarkus.datasource."<named-data-sources>".initial-size` icon:gears[title=Overridable at runtime]::
+
--
The initial size of the pool
...
`quarkus.datasource."<named-data-sources>".min-size` icon:gears[title=Overridable at runtime]::
+
--
The datasource pool minimum size
...
`quarkus.datasource."<named-data-sources>".max-size` icon:gears[title=Overridable at runtime]::
+
--
The datasource pool maximum size
...
`quarkus.datasource."<named-data-sources>".background-validation-interval` icon:gears[title=Overridable at runtime]::
+
--
The interval at which we validate idle connections in the background
...
`quarkus.datasource."<named-data-sources>".acquisition-timeout` icon:gears[title=Overridable at runtime]::
+
--
The timeout before cancelling the acquisition of a new connection
...
`quarkus.datasource."<named-data-sources>".leak-detection-interval` icon:gears[title=Overridable at runtime]::
+
--
The interval at which we check for connection leaks.
...
`quarkus.datasource."<named-data-sources>".idle-removal-interval` icon:gears[title=Overridable at runtime]::
+
--
The interval at which we try to remove idle connections.
...
`quarkus.datasource."<named-data-sources>".max-lifetime` icon:gears[title=Overridable at runtime]::
+
--
The max lifetime of a connection.
...
`quarkus.datasource."<named-data-sources>".transaction-isolation-level` icon:gears[title=Overridable at runtime]::
+
--
The transaction isolation level.
...
`quarkus.datasource."<named-data-sources>".enable-metrics` icon:gears[title=Overridable at runtime]::
+
--
Enable datasource metrics collection.
